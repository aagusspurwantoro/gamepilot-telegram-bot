...
A Telegram bot built with [aiogram 3](https://docs.aiogram.dev/) — a safe math calculator, a Black Desert Online market tax calculator, trash loot hours calculators (plain and Agris Fever), and silver/hours progress trackers.
...
| `/hours <current>/<goal> <added>` | Cumulative hours progress — `/hours 25h 40m/50h 5h 14m` -> `30h 54m / 50h (61.8%)` |
...
Get a bot token from [@BotFather](https://t.me/BotFather) on Telegram. The bot registers its command menu (`/bdotax`, `/hourly`, `/hours`, `/agris`, `/agriscost`, `/progress`) automatically on startup.
...
hours.py        — cumulative hours progress calculator
agris.py        — Agris Fever trash loot hours calculator
progress.py     — silver grinding progress calculator
pyproject.toml  — project metadata + pytest config
tests/          — pytest suite for the logic modules and the bot handlers
```
...
- [docs/hours.md](docs/hours.md) — usage, duration syntax and boundary rules
